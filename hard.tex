...
\hline
uPC & counter register & 16-bit & microprogram counter \\
...
uStack & 3-register bank & 16-bit & subprocedure return addresses \\
uMem & memory & 16-bit (data and addr) & contains hardcoded microprogram \\
