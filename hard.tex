...
$\mu$JumpTab & memory & 16-bit data, 5-bit addr & hardcoded jump table \\
\hline
\end{tabular}
...
$\mu$JBUS & 16 & Moves around the information for jumping \\
...
\vspace{6pt}
* These flippable registers supports clearing and hardware-based toggling of individual bits.
